...
async function sendPushNotifications(snapshot) {
  ...
  if (userRefsStr) {
    ...
    userTokens.docs.forEach((token) => {
      ...
      if (audienceMatches &&
          typeof data.fcm_token !== "undefined" &&
          data.fcm_token) {
...
// Test credentials
const kTestKeyId = "rzp_test_ST1TJFmdin3t51";
const kTestKeySecret = "N8sWqOlJ5tq7KSFD3bNSnXdK";

// Prod credentials
const kProdKeyId = "rzp_live_SYv2FFeu4uSUBT";
const kProdKeySecret = "GZVNxE19N58l7nh9hfGZ6yAJ";
...
exports.onUserDeleted = functions
  ...
  .onDelete(async (user) => {
    ...
    try {
      ...
      console.error(`Failed to delete users/${user.uid}: ${e}`);
    }
  });
