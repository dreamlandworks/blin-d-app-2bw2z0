...
import 'pop_up_confirm_model.dart';
export 'pop_up_confirm_model.dart';

class PopUpConfirmWidget extends StatefulWidget {
  const PopUpConfirmWidget({
    super.key,
    this.imagePath,
    String? headLine,
    String? message,
  ...
  @override
  State<PopUpConfirmWidget> createState() => _PopUpConfirmWidgetState();
}

class _PopUpConfirmWidgetState extends State<PopUpConfirmWidget> {
  late PopUpConfirmModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PopUpConfirmModel());
  }
