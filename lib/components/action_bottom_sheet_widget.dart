...
import 'action_bottom_sheet_model.dart';
export 'action_bottom_sheet_model.dart';
...
class _ActionBottomSheetWidgetState extends State<ActionBottomSheetWidget> {
  late ActionBottomSheetModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ActionBottomSheetModel());
  }
