...
import 'reveal_pending_sheet_model.dart';
export 'reveal_pending_sheet_model.dart';

class RevealPendingSheetWidget extends StatefulWidget {
  const RevealPendingSheetWidget({super.key});

  @override
  State<RevealPendingSheetWidget> createState() =>
      _RevealPendingSheetWidgetState();
}

class _RevealPendingSheetWidgetState extends State<RevealPendingSheetWidget> {
  late RevealPendingSheetModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RevealPendingSheetModel());
  }
