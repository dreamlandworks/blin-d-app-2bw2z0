...
import 'update_social_page_model.dart';
export 'update_social_page_model.dart';

class UpdateSocialPageWidget extends StatefulWidget {
  const UpdateSocialPageWidget({
    super.key,
    String? userLocation,
  ...
  static String routeName = 'updateSocialPage';
  static String routePath = '/updateSocialPage';

  @override
  State<UpdateSocialPageWidget> createState() => _UpdateSocialPageWidgetState();
}

class _UpdateSocialPageWidgetState extends State<UpdateSocialPageWidget> {
  late UpdateSocialPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UpdateSocialPageModel());

    _model.fbTextController ??=
        TextEditingController(text: currentUserDocument?.social.fbId);
    _model.fbFocusNode ??= FocusNode();

    _model.instaTextController ??=
        TextEditingController(text: currentUserDocument?.social.instaId);
    _model.instaFocusNode ??= FocusNode();

    _model.twitterTextController ??=
        TextEditingController(text: currentUserDocument?.social.xHandle);
    _model.twitterFocusNode ??= FocusNode();

    _model.tiktokTextController ??=
        TextEditingController(text: currentUserDocument?.social.tiktokId);
    _model.tiktokFocusNode ??= FocusNode();

    _model.spotifyTextController1 ??=
        TextEditingController(text: currentUserDocument?.social.spotifyUrl);
    _model.spotifyFocusNode1 ??= FocusNode();

    _model.spotifyTextController2 ??=
        TextEditingController(text: currentUserDocument?.social.website);
                            ...
                            Column(
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  decoration: const BoxDecoration(),
                                  child: Text(
                                    'Update social data for better matches',
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
                                          font: GoogleFonts.sora(
