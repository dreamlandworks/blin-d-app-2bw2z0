...
class _UpdateProfileWidgetState extends State<UpdateProfileWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      FFAppState().onboard = OnboardStruct(
        interests: currentUserDocument?.preferences.interests,
      );
      safeSetState(() {});
      _model.lookingFor = currentUserDocument!.preferences.interestedIn;
      _model.userLocation = currentUserDocument?.preferences.locationCity;
      safeSetState(() {});
    });

    _model.textController1 ??=
        TextEditingController(text: currentUserDocument?.realId.fullName);
                            ...
                            Column(
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  decoration: const BoxDecoration(),
                                  child: Text(
                                    'update and find your perfect match.',
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
                                          font: GoogleFonts.sora(
                                        ...
                                        child: InkWell(
                                          ...
                                          onTap: () async {
                                            ...
                                            if (selectedMedia != null &&
                                                selectedMedia.every((m) =>
                                                    validateFileFormat(
                                                        ...
                                                        context))) {
                                              safeSetState(() => _model
                                                      .isDataUploading_uploadDataPhotoRaw1 =
                                                  true);
                                              ...
                                              try {
                                                ...
                                                _model.isDataUploading_uploadDataPhotoRaw1 =
                                                    false;
                                              }
                                              if (selectedUploadedFiles
                                                ...
                                                safeSetState(() {
                                                  _model.uploadedLocalFile_uploadDataPhotoRaw1 =
                                                      selectedUploadedFiles
                                                          .first;
                                                });
                                              } else {
                                            ...
                                            _model.thumbFile =
                                              ...
                                              _model
                                                  .uploadedLocalFile_uploadDataPhotoRaw1,
                                            );
                                            _model.thumbUrl =
                                      ...
                                      return InkWell(
                                        ...
                                        child: wrapWithModel(
                                          ...
                                          child: StatPillWidget(
                                            key: Key(
                                              'Keyk4w_${interestsIndex.toString()}',
                                            ),
                                      ...
                                      return InkWell(
                                        ...
                                        child: wrapWithModel(
                                          ...
                                          child: InterestedChipWidget(
                                            key: Key(
                                              'Keyvcg_${interestsIndex.toString()}',
                                            ),
                                            icon: null,
                                            label:
